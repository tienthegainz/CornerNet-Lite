...
class CornerNet(Base):
    def __init__(self):
        ...
        model_path = get_file_path(
            "..", "cache", "nnet", "CornerNet", "CornerNet_500000.pkl")
        ...
        super(CornerNet, self).__init__(voc, cornernet,
                                        cornernet_inference, model=model_path)
...
class CornerNet_Squeeze(Base):
    def __init__(self):
        ...
        model_path = get_file_path(
            "..", "cache", "nnet", "CornerNet_Squeeze", "CornerNet_Squeeze_500000.pkl")
        ...
        cornernet = load_nnet(sys_cfg, model())
        super(CornerNet_Squeeze, self).__init__(
            voc, cornernet, cornernet_inference, model=model_path)
...
class CornerNet_Saccade(Base):
    def __init__(self):
        ...
        cfg_path = get_file_path(
            "..", "configs", "CornerNet_Saccade_custom.json")
        model_path = get_file_path(
            "..", "cache", "nnet", "CornerNet_Saccade", "CornerNet_Saccade_500000.pkl")
        ...
        cornernet = load_nnet(sys_cfg, model())
        super(CornerNet_Saccade, self).__init__(voc, cornernet,
                                                cornernet_saccade_inference, model=model_path)

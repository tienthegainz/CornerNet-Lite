...
class fire_module(nn.Module):
    def __init__(self, inp_dim, out_dim, sr=2, stride=1):
        ...
        self.conv1 = nn.Conv2d(inp_dim, out_dim // sr,
...
class model(hg_net):
    ...
    def __init__(self):
        ...
        tl_heats = nn.ModuleList([self._pred_mod(24) for _ in range(stacks)])
        br_heats = nn.ModuleList([self._pred_mod(24) for _ in range(stacks)])
